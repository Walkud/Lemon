 ...
 */
class HttpReqeustLog(val level: LemonLogLevel) {
    ...
    fun getRequestLog(request: Request): String {
        ...
        return StringBuilder().apply {
            ...
            if (level.value >= LemonLogLevel.ALL.value) {
                //构建 ApiService 相关信息
                append("\n")
                append("APISERVICE:\n")
            ...
            if (level.value >= LemonLogLevel.HEADERS.value) {
                //构建请求头信息
                append("\n")
            ...
            bodyContent?.let {
                if (level.value >= LemonLogLevel.BODY.value) {
                    append("BODY:\n")
                    append(bodyContent)
                }
                append("\n")
